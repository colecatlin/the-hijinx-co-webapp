        ...
        <AlertDialogHeader>
          <div className="flex items-center gap-3 mb-1">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
              style={{ background: `hsl(var(--danger) / 0.12)`, border: `1px solid ${DANGER} / 0.25)` }}>
              <AlertTriangle className="w-5 h-5" style={{ color: DANGER }} />
            </div>
            <AlertDialogTitle className="text-lg font-black m-0 p-0" style={{ color: 'hsl(var(--foreground))' }}>
              Delete my account
            </AlertDialogTitle>
          </div>
          ...
          {step === 1 ? (
            <AlertDialogDescription className="text-sm leading-relaxed text-left"
              ...
              <span className="font-bold" style={{ color: 'hsl(var(--foreground))' }}>This action is permanent.</span> Deleting your
              account will permanently remove your:
              <ul className="mt-2 ml-4 list-disc space-y-1" style={{ color: 'hsl(var(--foreground-secondary))' }}>
              ...
              <span className="block mt-3" style={{ color: 'hsl(var(--foreground-quiet))' }}>
            ...
            <AlertDialogDescription className="text-sm leading-relaxed text-left space-y-3"
              style={{ color: 'hsl(var(--foreground-secondary))' }}>
              <span className="block font-bold" style={{ color: 'hsl(var(--foreground))' }}>
              ...
              <input
                ...
                style={{
                  ...
                  border: confirmText && !canFinalize ? `1px solid ${DANGER} / 0.5)` : '1px solid hsl(var(--divider))',
                  color: 'hsl(var(--foreground))',
                }}
              />
              <span className="block" style={{ color: 'hsl(var(--foreground-quiet))' }}>
                Typing <span className="font-bold" style={{ color: 'hsl(var(--foreground))' }}>{CONFIRM_WORD}</span> will submit your
