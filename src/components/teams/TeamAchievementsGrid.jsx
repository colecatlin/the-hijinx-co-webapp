...
import { Trophy, Flag, Award, Crown, MapPin, Lock } from 'lucide-react';

const ICON_MAP = { Flag, Trophy, Award, Crown, MapPin, Lock };

export default function TeamAchievementsGrid({ achievements }) {
  if (!achievements || achievements.length === 0) {
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
        <Trophy className="w-10 h-10 text-gray-300 mx-auto mb-3" />
        <p className="text-gray-500 text-sm">No achievements yet. Achievements unlock as the team competes.</p>
      </div>
    );
  }
