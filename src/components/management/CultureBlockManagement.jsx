...
const PRESET_BLOCKS = [
  { title: 'Culture', label: 'Culture', description: 'Born from the garage. Built for the track. Worn everywhere else.', link_label: 'Shop Apparel', link_url: '/ApparelHome', sort_order: 0, is_active: true },
  { title: 'On Track', label: 'On Track', description: '', link_label: '', link_url: '/MotorsportsHome', sort_order: 1, is_active: true },
  { title: 'Media', label: 'Media', description: '', link_label: 'Media Portal', link_url: '/MediaHome', sort_order: 2, is_active: true },
  { title: 'Editorial', label: 'Editorial', description: 'We document what others overlook.', link_label: 'Explore', link_url: '/OutletHome', sort_order: 3, is_active: true },
];
