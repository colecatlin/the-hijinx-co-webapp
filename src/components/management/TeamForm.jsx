      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="border-t pt-6">
            <h3 className="text-sm font-semibold mb-4">Manufacturer/Sponsor Logo</h3>
            <div className="flex items-end gap-4">
              {formData.logo_url && (
                <div className="relative">
                  <img src={formData.logo_url} alt="Logo preview" className="h-24 w-auto object-contain border border-gray-300 rounded p-2" />
                  <button
                    type="button"
