...
export default function CultureGrid() {
  return (
    <section className="bg-[#F2EFE9] py-20 md:py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">

        {/* Section label */}
        <div className="flex items-center gap-3 mb-10">
          <div className="w-5 h-px bg-[#0C0C0B]" />
          <span className="text-[9px] font-bold tracking-[0.45em] uppercase text-[#0C0C0B]/40">
            HIJINX · Culture
          </span>
        </div>
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.6), 0 4px 40px rgba(0,0,0,0.08)',
            }}
          >
            <div className="absolute top-0 left-0 right-0 h-[1px]" style={{ background: 'linear-gradient(90deg, #00FFDA55 0%, transparent 70%)' }} />
            <div>
              <span className="text-[9px] font-bold tracking-[0.45em] uppercase block mb-6" style={{ color: '#00CCAA' }}>
                Culture
              </span>
              <h2 className="text-4xl font-black text-[#0C0C0B] tracking-tight leading-tight mb-4">
                Born from<br />the garage.
              </h2>
              <p className="text-[#0C0C0B]/50 text-sm leading-relaxed">
            ...
            <Link
              ...
              style={{ color: '#009980', borderBottom: '1px solid rgba(0,153,128,0.3)' }}
            >
          ...
          >
            <div className="absolute inset-0 pointer-events-none opacity-30" style={GRAIN_STYLE} />
            ...
            <div className="relative">
              <span className="text-[9px] font-bold tracking-[0.45em] uppercase block mb-3" style={{ color: 'rgba(140,120,0,0.6)' }}>
                Editorial
              </span>
              <p className="text-xl font-black text-[#0C0C0B] tracking-tight leading-snug">
                We document what others overlook.
              </p>
            </div>
            <Link
              to={createPageUrl('OutletHome')}
              className="relative inline-flex items-center gap-2 text-xs font-semibold text-[#0C0C0B]/40 hover:text-[#0C0C0B] transition-colors w-fit mt-3"
            >
