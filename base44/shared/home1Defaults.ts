  ...
  return {
    ...
    next_up: {
      ...
      view_calendar_cta: {
        ...
        destination: { type: 'internal_page', internal_page: '/Directory?cat=events', entity_type: '', entity_id: '', external_url: '', open_in_new_tab: false },
      },
      mode: 'auto',
      pinned_event_ids: [],
      display_limit: 10,
      ...
      tiles: [
        {
          ...
          destination: { type: 'internal_page', internal_page: '/ApparelHome', entity_type: '', entity_id: '', external_url: '', open_in_new_tab: false },
        ...
        },
        {
          ...
          destination: { type: 'internal_page', internal_page: '/OutletHome', entity_type: '', entity_id: '', external_url: '', open_in_new_tab: false },
        ...
        },
        {
          ...
          destination: { type: 'internal_page', internal_page: '/MotorsportsHome', entity_type: '', entity_id: '', external_url: '', open_in_new_tab: false },
        ...
        },
        {
          ...
          destination: { type: 'internal_page', internal_page: '/MarketplaceHome', entity_type: '', entity_id: '', external_url: '', open_in_new_tab: false },
        ...
        },
        {
          ...
          destination: { type: 'internal_page', internal_page: '/racecore', entity_type: '', entity_id: '', external_url: '', open_in_new_tab: false },
        ...
        },
        {
          ...
          destination: { type: 'internal_page', internal_page: '/join', entity_type: '', entity_id: '', external_url: '', open_in_new_tab: false },
