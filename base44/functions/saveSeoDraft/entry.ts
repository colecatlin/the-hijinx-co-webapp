...
import { getDefaultSeoConfig, validateSeoConfig } from '../../shared/seoDefaults.ts';

/**
 * saveSeoDraft
 *
 * Admin-only. Saves the draft SEO configuration without making it public.
...
export default async function (req) {
  try {
    ...
    const validation = validateSeoConfig(draft);
    if (!validation.valid) {
