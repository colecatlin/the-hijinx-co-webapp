...
import { getDefaultFooterConfig, validateFooterConfig } from '../../shared/footerDefaults.ts';

/**
 * saveFooterDraft
 *
 * Admin-only. Saves the draft footer configuration without making it public.
...
export default async function (req) {
  try {
    ...
    const validation = validateFooterConfig(draft);
    if (!validation.valid) {
